...
class Autenticacion{
    ...
    iniciarAutenticacion(): void{
        this.pedirDatos();
    }

    pedirDatos(): void{
        this.rl.question("Ingresa tu usuario: ", (user:string) => {
            this.rl.question("Ingresa tu contraseña: ", (pass:string) =>{
                this.rl.question("Ingrese su rol: 1 = Administrador, 2 = Cliente, 3 = Invitado ", (rol:string) =>{
    ...
    autenticarDatos(user:string, pass:string, rol:Number): void{
